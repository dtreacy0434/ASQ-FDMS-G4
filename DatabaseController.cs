...
namespace ASQ_DB
{
     class DatabaseController
    {
        ...
        private static readonly string ConnectionString = "Server=tcp:asq.database.windows.net,1433;Initial Catalog=asqDB;Persist Security Info=False;User ID=asqg4;Password=6yLej63JzuCXUts;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
