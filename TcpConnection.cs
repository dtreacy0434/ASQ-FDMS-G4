    ...
    public class TcpConnection
    {
        ...
        */
        public static void StartListening()
        {
            ...
            IPAddress ipAddress = ipHostInfo.AddressList[0];                                    // Convert previous line to IPAddress
        ...
        */
        public static void ReadCallback(IAsyncResult ar)
        {
            ...
            if (bytesRead > 0)
            {
                // Convert received byte[] data to workable string 
                state.sb.Append(Encoding.ASCII.GetString(
                    state.buffer, 0, bytesRead));

                // Save the received client data string to local string variable
                ...
                Task t = Task.Run(() => {
                    ...
                    string[] telemDataTokens = tempDataArray[2].Split(',');                     // Split telemData into tokens
                    ...
                    float[] copyFloatData = new float[tempTelemData.Length - 2];
                    ...
                    tData = new TelemData(tempDataArray[0], (string)tempTelemData[0], copyFloatData[0], copyFloatData[1], copyFloatData[2], copyFloatData[3], copyFloatData[4], copyFloatData[5], copyFloatData[6]);

                    // Confirm Checksum is valid
                    if ((int)((tData.Altitude + tData.Pitch + tData.Bank) / 3) == int.Parse(tempDataArray[tempDataArray.Length - 1]))
                    {
